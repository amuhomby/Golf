...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/FXImageView/FXImageView.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/VKFoundation/VKFoundation.framework"
  install_framework "$BUILT_PRODUCTS_DIR/VKVideoPlayer/VKVideoPlayer.framework"
fi

...
- (void)setUpGameView
{
    ...
    progressView = [[UIView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, self.frame.size.width, REFRESH_CONTROL_HEIGHT)];
...
- (void)setUpPaddles
{
    ...
    leftPaddleView.hidden = YES;
    rightPaddleView.hidden = YES;
}
...
- (void)beginLoading
{
    [SVProgressHUD setContainerView: progressView];

...
@interface dressAFViewController () <UITableViewDelegate, UITableViewDataSource>
{
...
@implementation dressAFViewController
...
-(void)viewDidLayoutSubviews{
    btnConti.layer.cornerRadius = btnConti.layer.bounds.size.height/2;

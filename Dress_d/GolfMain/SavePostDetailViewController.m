//
//  SavePostDetailViewController.m
//  Dress_d
//
...
@interface SavePostDetailViewController ()<UITextFieldDelegate, UIScrollViewDelegate>
{
    BOOL _isObserving;
    float _oriStoryY;
    NSString * fbid;
...
@implementation SavePostDetailViewController
...
-(IBAction)onClicklike:(UIButton *)sender{
    ...
    if([fbid isEqualToString:user_id]){
...
-(IBAction)onClickSetting:(id)sender{
    ...
    if([fbid isEqualToString:myfbid]){
        ...
        vc.post_id = _post_id;
        vc.imgUrl =  [_dicPostDetail objectForKey:@"photo"];
        vc.subject = subject;
        [self.navigationController pushViewController:vc animated:YES];
    }else{
